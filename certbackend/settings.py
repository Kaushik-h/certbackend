"""
Django settings for certbackend project.
...
SECRET_KEY = 'y_kq_ytulo3nm+-3*%h0@hy2e49c*p$pm*nyg^x0o@8t&6trbl'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'kaushikhareesh@gmail.com'
EMAIL_HOST_PASSWORD = 'djqhyyatogitknxv'